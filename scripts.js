...
var successSvg = `<svg width="40" height="42" viewBox="0 0 40 42" fill="none" xmlns="http://www.w3.org/2000/svg">
<g transform="translate(0, -5)" filter="url(#filter0_d_26_42)">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M19.293 28.293a1 1 0 011.414 0l8.293-8.293a1 1 0 00-1.414-1.414L20 25.172l-4.293-4.293a1 1 0 00-1.414 1.414l5 5z" fill="#00f64a"/>
</g>
<defs>
  <filter id="filter0_d_26_42" x="6" y="0" width="28" height="42" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
    <feFlood flood-opacity="0" result="BackgroundImageFix"/>
  ...
  window.addEventListener('message', function(event){
    ...
    if (item.runProgress === true) {
      ...
      if (item.colorsent == 'error') {
        element = $('<div id="colorsent' + item.colorsent + '" class="notification-bg error" style="display:none" data-total-time="' + fadetimer + '"><i class="icon">' + errorSvg + "</i>" + message + notifyTimer + '</div>'); 
      } else if (item.colorsent == 'success') {
        element = $('<div id="colorsent' + item.colorsent + '" class="notification-bg success" style="display:none" data-total-time="' + fadetimer + '"><i class="icon">' + successSvg + "</i>" + message + notifyTimer + '</div>');
      } else if (item.colorsent == 'success') {
        element = $('<div id="colorsent' + item.colorsent + '" class="notification-bg success2" style="display:none" data-total-time="' + fadetimer + '"><i class="icon">' + successSvg + "</i>" + message + notifyTimer + '</div>');
      } else if (item.colorsent == 'info') {
